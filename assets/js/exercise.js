...
(function () {
	exerciseCard.forEach((exercise) => {
		...
		let exerciseFeedbackIndividual = exercise.getAttribute("data-exercise-feedback");
		...
		answerOption.forEach((option) => {
			option.addEventListener("click", function () {
				...
				console.log(exerciseFeedbackIndividual);
				if (exerciseData === "one") {
		...
		function showAnswerFeedback(el) {
			// When feedback is correct or incorrect
			if (exerciseFeedbackIndividual === "general") {
				const feedbackCorrect = exercise.querySelector(".exercise__submit .feedback--correct").textContent;
				const feedbackIncorrect = exercise.querySelector(".exercise__submit .feedback--incorrect").textContent;
				// const feedbackMissing = exercise.querySelector(".exercise__submit .feedback--missing").textContent;

				// Teste if feedback missing exist
				const feedbackTextContent = exercise.querySelector(".exercise__submit .feedback--missing");
				let feedbackMissing = ""; // Default value or handle the absence

				if (feedbackTextContent) {
					feedbackMissing = feedbackTextContent.textContent;
				}

				if (exerciseData === "one") {
					if (el.hasAttribute("correct")) {
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">check_circle</span> <strong>Parabéns, você acertou!</strong><br><span class="feedback__content">` + feedbackCorrect + `</span></div>`;
						...
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">cancel</span> <strong>Você não selecionou a resposta correta!</strong><br><span class="feedback__content">` + feedbackIncorrect + `</span></div>`;
				...
				if (exerciseData === "multiple") {
					if (el === "correct") {
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">check_circle</span> <strong>Parabéns, você acertou todas as respostas!</strong><br><span class="feedback__content">` + feedbackCorrect + `</span></div>`;
						submitFeedback.classList.remove("d-none", "exercise__submit__feedback--incorrect", "exercise__submit__feedback--incomplete");
						submitFeedback.classList.add("exercise__submit__feedback--correct");
					} else if (el === "missing") {
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">cancel</span> <strong>Você não selecionou todas as resposta corretas!</strong><br><span class="feedback__content">` + feedbackMissing + `</span></div>`;
						...
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">cancel</span> <strong>Você não selecionou as resposta corretas!</strong><br><span class="feedback__content">` + feedbackIncorrect + `</span></div>`;
				...
				if (exerciseData === "dropdown") {
					if (el) {
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">check_circle</span> <strong>Parabéns, você acertou todas as alternativas!</strong><br><span class="feedback__content">` + feedbackCorrect + `</span></div>`;
						submitFeedback.classList.remove("d-none", "exercise__submit__feedback--incorrect");
						submitFeedback.classList.add("exercise__submit__feedback--correct");
					} else {
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">cancel</span> <strong>Você não selecionou as alternativas corretas!</strong><br><span class="feedback__content">` + feedbackIncorrect + `</span></div>`;
						submitFeedback.classList.remove("d-none", "exercise__submit__feedback--correct");
						submitFeedback.classList.add("exercise__submit__feedback--incorrect");
					}
				}
			} else if (exerciseFeedbackIndividual === "individual") {
				if (exerciseData === "one") {
				...
				if (exerciseData === "dropdown") {
					if (!el) {
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">cancel</span> <strong>Você não selecionou as alternativas corretas!</strong></span></div>`;
						submitFeedback.classList.remove("d-none", "exercise__submit__feedback--correct");
						submitFeedback.classList.add("exercise__submit__feedback--incorrect");
						...
						submitFeedback.innerHTML = `<div><span class="material-symbols-rounded">check_circle</span><strong>Parabéns, você acertou todas as alternativas.</strong></div>`;
						submitFeedback.classList.remove("d-none", "exercise__submit__feedback--incorrect");
						submitFeedback.classList.add("exercise__submit__feedback--correct");
					}
				}
